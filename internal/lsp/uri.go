...
// computing the correct UTF-16 column by reading the target file from disk.
// Falls back to column 0 on any I/O error.
...
// Reads src from disk when nil; falls back to a collapsed range on error.
